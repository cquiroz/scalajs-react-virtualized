...
object TableTests extends TestSuite with TestUtils {
  ...
  val tests = Tests {
    ...
    "support rendering" - {
      ...
      val html =
        """<div aria-colcount="0" aria-rowcount="1" class="ReactVirtualized__Table" role="grid">
            ...
            |<div aria-label="grid" class="ReactVirtualized__Grid ReactVirtualized__Table__Grid" role="rowgroup" style="box-sizing: border-box; direction: ltr; height: 190px; position: relative; width: 500px; overflow-x: hidden; overflow-y: hidden;" tabindex="0">
              |<div class="ReactVirtualized__Grid__innerScrollContainer" role="rowgroup" style="width: auto; height: 40px; max-width: 500px; max-height: 40px; overflow: hidden; position: relative;">
                |<div aria-rowindex="1" aria-label="row" tabindex="0" class="ReactVirtualized__Table__row" role="row" style="overflow: hidden; left: 0px; padding-right: 0px; height: 40px; position: absolute; width: 500px; top: 0px;"></div>
                |</div>
              |</div>
    ...
    "support rendering with columns" - {
      ...
      val table = Table(Table.props(headerHeight = 10,
                                    height    = 200,
                                    rowCount  = 1,
                                    rowHeight = 40,
                                    width     = 500,
      ...
      val html =
        """<div aria-colcount="1" aria-rowcount="1" class="ReactVirtualized__Table" role="grid">
            ...
            |<div aria-label="key" aria-sort="none" class="ReactVirtualized__Table__headerColumn" role="columnheader" tabindex="0"><span class="ReactVirtualized__Table__headerTruncatedText"></span></div>
            |</div>
            |<div aria-label="grid" class="ReactVirtualized__Grid ReactVirtualized__Table__Grid" role="rowgroup" style="box-sizing: border-box; direction: ltr; height: 190px; position: relative; width: 500px; overflow-x: hidden; overflow-y: hidden;" tabindex="0">
              |<div class="ReactVirtualized__Grid__innerScrollContainer" role="rowgroup" style="width: auto; height: 40px; max-width: 500px; max-height: 40px; overflow: hidden; position: relative;">
                |<div aria-rowindex="1" aria-label="row" tabindex="0" class="ReactVirtualized__Table__row" role="row" style="overflow: hidden; left: 0px; padding-right: 0px; height: 40px; position: absolute; width: 500px; top: 0px;">
                  |<div aria-colindex="1" class="ReactVirtualized__Table__rowColumn" role="gridcell" style="overflow: hidden;" title=""></div>
                |</div>
                |</div>
              |</div>
            |</div>""".stripMargin.replaceAll("[\n\r]", "")
    ...
    "support disableHeader" - {
      ...
      val table2 = Table(Table.props(disableHeader = true,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
                                     rowHeight    = 40,
    ...
    "support noRowsRenderer" - {
      ...
      val table2 = Table(Table.props(noRowsRenderer = noRowsRenderer,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
                                     rowHeight    = 40,
    ...
    "support overscanRowCount" - {
      ...
      val table2 = Table(Table.props(overscanRowCount = 50,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
                                     rowHeight    = 40,
    ...
    "support rowClassName as string" - {
      ...
      val table2 = Table(Table.props(rowClassName = "class",
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
                                     rowHeight    = 40,
    ...
    "support rowClassName as a function" - {
      ...
      val table2 = Table(Table.props(rowClassName = rowClassNameFn,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
                                     rowHeight    = 40,
    ...
    "support style" - {
      ...
      val table2 = Table(Table.props(style = Style(styleMap),
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
    ...
    "support tabIndex" - {
      ...
      val table2 = Table(Table.props(tabIndex = 1,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
    ...
    "support sortBy" - {
      ...
      val table = Table(Table.props(rowHeight = 20,
                        ...
                        columns: _*)
      table.props.sortBy ==> (())
      val table2 = Table(Table.props(sortBy = "key",
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
    ...
    "support scrollToIndex" - {
      ...
      val table2 = Table(Table.props(scrollToIndex = 1,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
    ...
    "support scrollTop" - {
      ...
      val table2 = Table(Table.props(scrollTop = 1,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
      ...
      val table3 = Table(Table.props(scrollTop = 1.5,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
    ...
    "support sortDirection" - {
      ...
      val table2 = Table(Table.props(sortDirection = SortDirection.DESC,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
    ...
    "support sort" - {
      ...
      val table2 = Table(Table.props(sort = sortFunction _,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
    ...
    "support scrollToAlignment" - {
      ...
      val table2 = Table(Table.props(scrollToAlignment = ScrollToAlignment.Center,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
    ...
    "support rowStyle as object" - {
      ...
      val style    = js.Dynamic.literal(foo = 42, bar = "foobar")
      val styleMap = Map[String, String | Int]("foo" -> 42, "bar" -> "foobar")
      val table2 = Table(Table.props(rowStyle = Style(styleMap),
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
    ...
    "support rowStyle as function" - {
      ...
      val table = Table(Table.props(rowStyle = rowStyleF,
                                    rowHeight    = 20,
                                    headerHeight = 10,
                                    height       = 200,
                                    rowCount     = 1,
    ...
    "support aria-label" - {
      ...
      val table2 = Table(Table.props(ariaLabel = "label",
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
    ...
    "support auto-height" - {
      ...
      val table2 = Table(Table.props(autoHeight = true,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
                                     rowCount     = 1,
    ...
    "support className" - {
      ...
      val table2 = Table(Table.props(className = "class",
                                     autoHeight   = true,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
    ...
    "support estimatedRowSize " - {
      ...
      val table2 = Table(Table.props(estimatedRowSize = 10,
                                     autoHeight   = true,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
      ...
      val table3 = Table(Table.props(estimatedRowSize = 10.5,
                                     autoHeight   = true,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
    ...
    "support gridClassName " - {
      ...
      val table2 = Table(Table.props(gridClassName = "class",
                                     autoHeight   = true,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
    ...
    "support gridStyle " - {
      ...
      val style    = js.Dynamic.literal(foo = 42, bar = "foobar")
      val styleMap = Map[String, String | Int]("foo" -> 42, "bar" -> "foobar")
      val table2 = Table(Table.props(gridStyle = Style(styleMap),
                                     autoHeight   = true,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
    ...
    "support headerStyle " - {
      ...
      val style    = js.Dynamic.literal(foo = 42, bar = "foobar")
      val styleMap = Map[String, String | Int]("foo" -> 42, "bar" -> "foobar")
      val table2 = Table(Table.props(headerStyle = Style(styleMap),
                                     autoHeight   = true,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
    ...
    "support id " - {
      ...
      val table = Table(Table.props(rowHeight = 20,
                        ...
                        columns: _*)
      table.props.id ==> (())
      val table2 = Table(Table.props(id = "id",
                                     autoHeight   = true,
                                     rowHeight    = 20,
                                     headerHeight = 10,
                                     height       = 200,
    ...
    "support a default headerRowRenderer " - {
      ...
      assertRender(
        unmounted.rawNode,
        """<div><div class="class" role="row" style="foo:42px;bar:foobar"><div>Hello there abc</div></div></div>"""
      )
      val html =
        """<div aria-colcount="1" aria-rowcount="1" class="ReactVirtualized__Table" role="grid">
            |<div class="ReactVirtualized__Table__headerRow" role="row" style="height: 10px; overflow: hidden; padding-right: 0px; width: 500px;"><div aria-label="key" aria-sort="none" class="ReactVirtualized__Table__headerColumn" role="columnheader" tabindex="0"><span class="ReactVirtualized__Table__headerTruncatedText"></span></div></div>
            |<div aria-label="grid" class="ReactVirtualized__Grid ReactVirtualized__Table__Grid" role="rowgroup" style="box-sizing: border-box; direction: ltr; height: 190px; position: relative; width: 500px; overflow-x: hidden; overflow-y: hidden;" tabindex="0">
              |<div class="ReactVirtualized__Grid__innerScrollContainer" role="rowgroup" style="width: auto; height: 20px; max-width: 500px; max-height: 20px; overflow: hidden; position: relative;">
                |<div aria-rowindex="1" aria-label="row" tabindex="0" class="ReactVirtualized__Table__row" role="row" style="overflow: hidden; left: 0px; padding-right: 0px; height: 20px; position: absolute; width: 500px; top: 0px;"><div aria-colindex="1" class="ReactVirtualized__Table__rowColumn" role="gridcell" style="overflow: hidden;" title=""></div></div>
                |</div>
              |</div>
            |</div>""".stripMargin.replaceAll("[\n\r]", "")
      ReactTestUtils.withRenderedIntoDocument(table) { m =>
    ...
    "support a custom headerRowRenderer " - {
      ...
      val table = Table(Table.props(headerRowRenderer = headerRowRendererF _,
                                    rowHeight    = 20,
                                    headerHeight = 10,
                                    height       = 200,
                                    rowCount     = 1,
      ...
      val headerRowParam = RawHeaderRowRendererParameter("class", js.Array(column.rawNode), style)
      val unmounted      = table.props.headerRowRenderer(headerRowParam)
      assertRender(unmounted.rawNode,
                   """<div><li class="class"><div>Hello there abc</div></li></div>""")
      val html =
        """<div aria-colcount="1" aria-rowcount="1" class="ReactVirtualized__Table" role="grid">
